package com.example.wujiawen.ExampleTextView;//com.example.wujiawen.ExampleTextView.ExpandTextView
...
public class ExpandTextView extends View implements View.OnClickListener {
    ...
    private void startDrawAnim(int startHeight, int endHeight) {
        /**
         * TODO
         * ObjectAnimator内部的工作机制是通过寻找特定属性的get和set方法，然后通过方法不断地对值进行改变，从而实现动画效果的。因此我们就需要在MyAnimView中定义一个color属性，并提供它的get和set方法
         */
...
//        animator.setInterpolator(new AccelerateDecelerateInterpolator());
    ...
    public  void setViewHeight(int viewHeight) {
        ...
        requestLayout();
        Log.i("wjw01","--ExpandTextView--setViewHeight--viewHeight-->>"+viewHeight);
    }
