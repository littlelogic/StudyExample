package com.example.wujiawen.Example_b;
...
//			canvas.drawArc(rectBlackBg, 90, -360, false, mPaint);
			canvas.drawArc(rectBlackBg, 0, 200, false, mPaint);

			/*mPaint.setTextAlign(Paint.Align.CENTER);
			mPaint.setTextSize(30);
			canvas.drawText("START ALL.",0,mHeight/2,mPaint);*/
