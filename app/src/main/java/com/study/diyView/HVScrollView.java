...
public class HVScrollView extends ViewGroup implements
...
//    private boolean mIsBeingDragged;
     ...
     *
     * @see #setOnScrollChangeListener( HVScrollView.OnScrollChangeListener)
     */
...
//    private boolean mIsBeingDragged = false;
    ...
    private  HVScrollView.SavedState mSavedState;

    private static final  HVScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new  HVScrollView.AccessibilityDelegate();
    ...
    private  HVScrollView.OnScrollChangeListener mOnScrollChangeListener;
...
//        a.recycle();
     ...
     * @see View#getScrollY()
     */
    public void setOnScrollChangeListener( HVScrollView.OnScrollChangeListener l) {
...
//                canvas.rotate(90, 0, 0);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof  HVScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

         HVScrollView.SavedState ss = ( HVScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        Parcelable superState = super.onSaveInstanceState();
         HVScrollView.SavedState ss = new  HVScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator< HVScrollView.SavedState> CREATOR
                = new Creator< HVScrollView.SavedState>() {
            public  HVScrollView.SavedState createFromParcel(Parcel in) {
                return new  HVScrollView.SavedState(in);
            }

            public  HVScrollView.SavedState[] newArray(int size) {
                return new  HVScrollView.SavedState[size];
            }
        };
    }
