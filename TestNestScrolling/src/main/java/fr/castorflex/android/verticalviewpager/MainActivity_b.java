...
//fr.castorflex.android.verticalviewpager.MainActivity_b
...
import com.yluo.testnestscrolling.R;

import java.util.Locale;

import fr.castorflex.android.verticalviewpager.VerticalViewPager;

public class MainActivity_b extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verticalViewPager.setAdapter(new DummyAdapter(mFragmentManager));
